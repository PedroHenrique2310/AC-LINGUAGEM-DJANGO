class Mago():
    ...
    def __init__(self,nome='mago genérico',vida_max=100, veneno = 'false', antidoto = 'false'):
...
class Lutador():
    ...
    def __init__(self,nome='lutador genérico',vida_max=150, veneno = 'false', antidoto = 'false'):
        self.vida_max = vida_max
        self.vida = vida_max
        self.nome = nome
        self.armas = {}
...
class Barbaro():
    ...
    def __init__(self,nome='barbaro genérico',vida_max=200, veneno = 'false', antidoto = 'false'):
        self.vida_max = vida_max
        self.vida = vida_max
        self.nome = nome
        self.armas = {}
